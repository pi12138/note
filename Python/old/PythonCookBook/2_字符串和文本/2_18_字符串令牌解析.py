...
print(master_pat)   # > re.compile('(?P<NAME>[a-zA-Z0-9][a-zA-Z0-9]*)|(?P<EQ>=)|(?P<NUM>\\d+)|(?P<PLUS>\\+)|(?P<TIMES>\\*)|(?P<WS>\\s+)')
...
print(scanner.match())          # > <_sre.SRE_Match object; span=(3, 4), match=' '>

print(scanner.match())          # > <_sre.SRE_Match object; span=(4, 5), match='='>

print(scanner.match())          # > <_sre.SRE_Match object; span=(5, 6), match=' '>

print(scanner.match())          # > <_sre.SRE_Match object; span=(6, 8), match='42'>
