...
print(s.format_map({"name":"Guido","n":37}))	# > "Guido has 37 messages."
...
print(vars(a))					# > "{'name': 'guido', 'n': '20'}"
print(s.format_map(vars(a)))	# > "guido has 20 messages."
...
print(sub("hello {name}"))						# > "hello gudio"
